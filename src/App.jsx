...
const App = () => {
  ...
  return (
    <main className="flex justify-center items-center w-full h-screen">
      <div className="text-black text-4xl flex flex-col gap-y-3 justify-end md:justify-center md:items-center bg-black h-screen p-3 md:w-1/2 lg:w-1/5 md:h-fit md:rounded-3xl">
        <section>
          <input
            type="text"
